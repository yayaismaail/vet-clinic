...
**[Vet-clinic database]** is a project that use a relational database to create the data structure for a vet-clinic. That is, it uses a relational database to create the initial data structure for a vet clinic and create a table to store animals' information, insert some data into it, and query it.
...
git clone https://github.com/yayaismaail/vet-clinic
...
Feel free to check the [issues page](https://github.com/yayaismaail/vet-clinic/issues).
